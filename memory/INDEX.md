...
- [`stryker-concurrency-coverage`](process/stryker-concurrency-coverage.md) — when running Stryker mutation tests, always concurrency 16 + coverage-analysis perTest; 24 threads inflates the score with false timeout-kills
