...
description: When a caller needs stable facts about an aggregate already on a canonical read model (`UserInfo`, `TeamInfo`), add scalar fields to that DTO instead of a new service method.
---
