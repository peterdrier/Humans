...
description: When a new project rule surfaces, write a `memory/<bucket>/<name>.md` atom + one-line `INDEX.md` entry in the same commit — never rely on external memory for project rules.
---
