...
description: "HARD RULE. Feature branch + PR for all code/docs/config changes, even trivial ones. Narrow exception: `memory/**`-only changes may go direct to `origin/main`."
---
