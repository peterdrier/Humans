...
description: At our small scale with no data-leak risk, an auth guard on a cheap `[AllowAnonymous]` DB read is dead defensive code. Don't flag in code review.
---
...
3. Otherwise: don't flag it. At our scale, a cheap extra DB read on a rare code path is fine.
