...
description: Never endorse a test/guardrail that pins a path/URL/assembly list as a literal — derive it from the registry — the app is composed by reflection.
---
