...
| One-off spanning sections, or in `Humans.Base` / `Humans.Web` / shared test projects (`Humans.Testing`, `Humans.Integration.Tests`, `Humans.Web.Tests`) / infrastructure | `inbox:` in [`docs/architecture/debt-ledger.yml`](../../docs/architecture/debt-ledger.yml) |
