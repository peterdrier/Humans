...
| One-off spanning sections, or in `Humans.Base` / `Humans.Web` / shared `tests/` projects / infrastructure | `inbox:` in [`docs/architecture/debt-ledger.yml`](../../docs/architecture/debt-ledger.yml) |
