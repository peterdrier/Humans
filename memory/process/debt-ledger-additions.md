...
| One-off inside a section's own test project, `tests/Humans.<X>.Tests` — that project is section-owned, so it follows the section | that same section's `Docs/debt.yml` |
