...
| One-off spanning sections, or in `Humans.Base` / `Humans.Web` / infrastructure / shared test plumbing (`tests/Humans.Testing`, `tests/Humans.Application.Tests`, `tests/Humans.Web.Tests`) | `inbox:` in [`docs/architecture/debt-ledger.yml`](../../docs/architecture/debt-ledger.yml) |
