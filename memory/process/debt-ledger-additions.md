...
| One-off spanning sections, or in `Humans.Base` / `Humans.Web` / shared test infrastructure (`tests/Humans.Testing`, `Humans.Integration.Tests`) / infrastructure | `inbox:` in [`docs/architecture/debt-ledger.yml`](../../docs/architecture/debt-ledger.yml) |
