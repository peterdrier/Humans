...
- Workspace: branch off `origin/main` in a worktree at `.claude/worktrees/trim-tests-<area>` locally, or in the repo root in a cloud run (`memory/process/always-use-worktree.md`)
