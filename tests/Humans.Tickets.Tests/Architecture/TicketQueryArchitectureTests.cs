...
/// <see cref="ITicketRepository"/> and never takes <c>IMemoryCache</c>. The Singleton
/// <see cref="CachingTicketQueryService"/>
/// decorator (Services/Stores/) owns the tracked ticket slices and invalidation
