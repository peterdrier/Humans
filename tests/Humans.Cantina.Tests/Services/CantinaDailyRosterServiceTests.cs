...
public class CantinaDailyRosterServiceTests
{
    ...
    public CantinaDailyRosterServiceTests()
    {
        ...
        _appSettings = Substitute.For<ISettingsServiceRead>();
        ...
        _service = new CantinaRosterService(_shiftMgmt, _appSettings, _userRead, _clock);
    }
    ...
    public async Task GetDailyRoster_IncludesNextDayArrivals()
    {
        ...
        _appSettings.GetActiveEventSettingsAsync(Arg.Any<CancellationToken>()).Returns(ev);
    ...
    public async Task GetDailyRoster_EventTodayDate_ComesFromEventTimezone()
    {
        ...
        var service = new CantinaRosterService(_shiftMgmt, _appSettings, _userRead, fakeClock);
        var es = ActiveEvent();
        _appSettings.GetActiveEventSettingsAsync(Arg.Any<CancellationToken>()).Returns(es);
