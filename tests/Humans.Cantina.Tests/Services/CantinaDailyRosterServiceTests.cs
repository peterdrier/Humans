...
public class CantinaDailyRosterServiceTests
{
    ...
    private readonly ISettingsService _eventSettings;
    ...
    public CantinaDailyRosterServiceTests()
    {
        ...
        _eventSettings = Substitute.For<ISettingsService>();
        ...
        _service = new CantinaRosterService(_shiftMgmt, _eventSettings, _userRead, _clock);
    }

    /// <summary>Builds a profile carrying burner name + dietary (dietary lives on the profile).</summary>
    ...
    public async Task GetDailyRoster_IncludesNextDayArrivals()
    {
        ...
        _eventSettings.GetActiveEventSettingsAsync(Arg.Any<CancellationToken>()).Returns(ev);
    ...
    {
        _eventSettings.GetActiveEventSettingsAsync(Arg.Any<CancellationToken>()).Returns((EventSettingsInfo?)null);
    ...
    {
        var es = ActiveEvent();
        _eventSettings.GetActiveEventSettingsAsync(Arg.Any<CancellationToken>()).Returns(es);
    ...
    public async Task GetDailyRoster_BurnerName_ComesFromTheResolvedUserName()
    {
        ...
        // user row.
        _eventSettings.GetActiveEventSettingsAsync(Arg.Any<CancellationToken>()).Returns(ActiveEvent());
    ...
    public async Task GetDailyRoster_MedicalConditionsNeverInDto()
    {
        ...
        typeof(Humans.Cantina.Services.Dtos.DailyPersonRowDto)
    ...
    public async Task GetDailyRoster_EventTodayDate_ComesFromEventTimezone()
    {
        ...
        var service = new CantinaRosterService(_shiftMgmt, _eventSettings, _userRead, fakeClock);
        var es = ActiveEvent();
        _eventSettings.GetActiveEventSettingsAsync(Arg.Any<CancellationToken>()).Returns(es);
