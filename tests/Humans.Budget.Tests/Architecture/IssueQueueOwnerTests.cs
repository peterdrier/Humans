...
/// <summary>
/// Budget declares the issue queue it owns. Issues routes on what DI discovered, so this
...
public class IssueQueueOwnerTests
{
    ...
    {
        Owner.QueueKey.Should().Be("Budget");
        Owner.OwningRoles.Should().Equal(RoleNames.FinanceAdmin);
    }
    ...
    public void Queue_declaration_publishes_its_own_section_annotation()
    {
        ...
        annotation.Section.Should().Be("Budget");
