...
public sealed class ShiftManagementServiceCoveragePiesTests : ShiftsTestHarness
{
    ...
    public async Task ResultSortedAlphabetically_ByTeamName_ParentNamePopulatedForSubteams()
    {
        ...
        await TeamsDb.Teams.AddRangeAsync(mango, appleSlice, banana);
