...
/// </para>
/// <para>
/// <b>Cross-part resolution in this direction was already proven</b> by Tour's
/// <c>_ViewStart.cshtml</c> at the time (it resolved <c>_Layout</c> out of <c>Humans.Web</c>;
/// Tour has since moved to its own <c>_TourLayout</c>). What was new in 4b-ii is the volume: 41 call sites (27
