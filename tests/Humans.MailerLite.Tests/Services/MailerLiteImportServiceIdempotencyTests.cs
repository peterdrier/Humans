...
public class MailerLiteImportServiceIdempotencyTests
{
    /// <summary>
...
///
/// The current <see cref="MailerLiteImportService"/> only calls <c>LogAsync</c> once per
...
internal sealed class AuditCounter
{
    ...
    /// Must stay 0 as long as MailerLiteImportService has no per-row audit writes.
    /// </summary>
