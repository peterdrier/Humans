...
public class MailerLiteImportServiceConflictRuleTests
{
...
/// <summary>
/// NSubstitute-based composition root for <see cref="MailerLiteImportService"/> apply/conflict-rule tests.
/// </summary>
