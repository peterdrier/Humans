...
public class HoldedExpenseOutboxJobTests
{
    ...
    private readonly HoldedExpenseOutboxJob _job;
    ...
    public HoldedExpenseOutboxJobTests()
    {
        ...
        _job = new HoldedExpenseOutboxJob(
            _repo,
            _budgetService,
            _userService,
            _holdedClient,
            _attachmentStorage,
            _clock,
            Substitute.For<ILogger<HoldedExpenseOutboxJob>>());
    }
    ...
    public async Task PayeeIban_NeverAppearsInLogMessages()
    {
        ...
        var logger = Substitute.For<ILogger<HoldedExpenseOutboxJob>>();
