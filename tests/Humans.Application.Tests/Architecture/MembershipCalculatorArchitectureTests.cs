...
{
    [HumansFact]
    public void MembershipCalculatorArchitecture_contracts_hold()
    {
        MembershipCalculator_LivesInHumansApplicationServicesGovernanceNamespace();
        MembershipCalculator_HasNoDbContextConstructorParameter();
        MembershipCalculator_HasNoDbContextFactoryConstructorParameter();
        MembershipCalculator_HasNoRepositoryConstructorParameter();
        MembershipCalculator_TakesProfileService();
        MembershipCalculator_TakesMembershipQuery();
        MembershipCalculator_DoesNotTakeTeamServiceDirectly();
        MembershipCalculator_DoesNotTakeRoleAssignmentServiceDirectly();
        MembershipCalculator_TakesUserService();
        MembershipCalculator_IsSealed();
    }
