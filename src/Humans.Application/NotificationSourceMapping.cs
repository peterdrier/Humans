...
public static class NotificationSourceMapping
{
    public static MessageCategory ToMessageCategory(this NotificationSource source) => source switch
    {
        ...
        NotificationSource.ApplicationApproved => MessageCategory.System,
        NotificationSource.ApplicationRejected => MessageCategory.System,
        NotificationSource.VolunteerApproved => MessageCategory.System,
