...
/// </para>
/// </remarks>
public static class ShiftUserSummaryProjection
{
    /// <summary>Projects one user's row bundle.</summary>
    public static ShiftUserSummary ToSummary(this ShiftUserView rows) => new(
        rows.UserId,
    ...
    public static IReadOnlyDictionary<Guid, ShiftUserSummary> ToSummaries(
