...
public class ShiftAdminController : HumansTeamControllerBase
{
    ...
    private async Task<(IActionResult? ErrorResult, User User, TeamInfo Team)> ResolveDepartmentManagementAsync(string slug)
    {
    ...
    private async Task<(IActionResult? ErrorResult, User User, TeamInfo Team)> ResolveDepartmentApprovalAsync(string slug)
    {
        return await ResolveDepartmentAccessAsync(
            slug,
    ...
    private async Task<bool> CanManageDepartmentAsync(User user, TeamInfo team)
    {
    ...
    private async Task<bool> CanApproveDepartmentAsync(User user, TeamInfo team)
    {
