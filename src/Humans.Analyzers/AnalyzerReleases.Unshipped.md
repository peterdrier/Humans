...
HUM0034 | Humans.Architecture   | Error    | Public type in a [assembly: Section("…")] assembly that is not the Section entry point, the <Section>Resource marker, an EF migration, or under Contracts/ (downgrades to Warning for types carrying [Grandfathered("HUM0034", ...)])
