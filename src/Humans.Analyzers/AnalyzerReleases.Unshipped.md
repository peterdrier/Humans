...
HUM0036 | Humans.Architecture   | Error    | View component invoked by its string name (IViewComponentHelper.InvokeAsync(string, …), the InvokeAsync(helper, string) extension, Controller.ViewComponent(string, …)) — invoke it by Type; analyzes Razor-generated code, skipping unmapped <vc:> tag-helper internals
