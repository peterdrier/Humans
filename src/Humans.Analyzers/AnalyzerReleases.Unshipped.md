...
HUM0031 | Humans.Architecture   | Error    | Controller method exceeds the business-logic thresholds (statements > 34 or cyclomatic complexity > 15) — move the logic into the section's application service (downgrades to Warning for methods carrying [Grandfathered("HUM0031", ...)])
