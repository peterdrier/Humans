...
namespace Humans.Infrastructure.Migrations
{
    ...
    [Migration("20260604000548_AddBarrioShiftObligations")]
    partial class AddBarrioShiftObligations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Humans.Domain.Entities.CampSeasonShiftObligation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("RequiredShiftCount")
                        .HasColumnType("integer");

                    b.Property<Guid>("ShiftObligationId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ShiftObligationId");

                    b.HasIndex("CampSeasonId", "ShiftObligationId")
                        .IsUnique()
                        .HasDatabaseName("IX_camp_season_shift_obligations_unique");

                    b.ToTable("camp_season_shift_obligations", (string)null);
                });
            ...
            modelBuilder.Entity("Humans.Domain.Entities.ShiftObligation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("CampRoleSlug")
                        .IsRequired()
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");
                    ...
                    b.Property<int>("DefaultRequiredShiftCount")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("shift_obligations", (string)null);
                });
            ...
            modelBuilder.Entity("Humans.Domain.Entities.CampSeasonShiftObligation", b =>
                {
                    ...
                    b.HasOne("Humans.Domain.Entities.ShiftObligation", "ShiftObligation")
                        .WithMany("Overrides")
                        .HasForeignKey("ShiftObligationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ShiftObligation");
                });
