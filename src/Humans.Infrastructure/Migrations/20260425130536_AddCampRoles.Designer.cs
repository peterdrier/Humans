...
namespace Humans.Infrastructure.Migrations
{
    ...
    [Migration("20260425130536_AddCampRoles")]
            ...
            modelBuilder.Entity("Humans.Domain.Entities.CampRoleAssignment", b =>
                {
                    ...
                    b.HasIndex("CampSeasonId", "CampRoleDefinitionId", "SlotIndex")
                        .IsUnique()
            ...
            modelBuilder.Entity("Humans.Domain.Entities.CampRoleDefinition", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c0a0a0a0-0000-0000-0000-000000000001"),
                            CreatedAt = NodaTime.Instant.FromUnixTimeTicks(17769888000000000L),
                            IsRequired = true,
                            MinimumRequired = 1,
                            Name = "Consent Lead",
                            SlotCount = 2,
                            SortOrder = 10,
                            UpdatedAt = NodaTime.Instant.FromUnixTimeTicks(17769888000000000L)
                        },
                        new
                        {
                            Id = new Guid("c0a0a0a0-0000-0000-0000-000000000002"),
                            CreatedAt = NodaTime.Instant.FromUnixTimeTicks(17769888000000000L),
                            IsRequired = true,
                            MinimumRequired = 1,
                            Name = "Wellbeing Lead",
                        ...
                        new
                        {
                            Id = new Guid("c0a0a0a0-0000-0000-0000-000000000003"),
                            CreatedAt = NodaTime.Instant.FromUnixTimeTicks(17769888000000000L),
                            IsRequired = true,
                            MinimumRequired = 1,
                            Name = "LNT",
                        ...
                        new
                        {
                            Id = new Guid("c0a0a0a0-0000-0000-0000-000000000004"),
                            CreatedAt = NodaTime.Instant.FromUnixTimeTicks(17769888000000000L),
                            IsRequired = true,
                            MinimumRequired = 1,
                            Name = "Shit Ninja",
                        ...
                        new
                        {
                            Id = new Guid("c0a0a0a0-0000-0000-0000-000000000005"),
                            CreatedAt = NodaTime.Instant.FromUnixTimeTicks(17769888000000000L),
                            IsRequired = false,
                            MinimumRequired = 0,
                            Name = "Power",
                        ...
                        new
                        {
                            Id = new Guid("c0a0a0a0-0000-0000-0000-000000000006"),
                            CreatedAt = NodaTime.Instant.FromUnixTimeTicks(17769888000000000L),
                            IsRequired = true,
                            MinimumRequired = 1,
                            Name = "Build Lead",
            ...
            modelBuilder.Entity("Humans.Domain.Entities.CampMember", b =>
                {
                    ...
                    b.HasOne("Humans.Domain.Entities.User", "ConfirmedByUser")
                        .WithMany()
                        .HasForeignKey("ConfirmedByUserId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Humans.Domain.Entities.User", "RemovedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Humans.Domain.Entities.CampRoleAssignment", b =>
                {
                    ...
                    b.HasOne("Humans.Domain.Entities.CampRoleDefinition", "CampRoleDefinition")
                    ...
                    b.Navigation("CampRoleDefinition");
