...
internal sealed class BudgetRepository(IDbContextFactory<BudgetDbContext> factory, ILogger<BudgetRepository> logger)
    : IBudgetRepository
{
    ...
    private static void AddDefaultTicketingCategories(
        BudgetDbContext ctx, Guid ticketingGroupId, Instant now)
    {
