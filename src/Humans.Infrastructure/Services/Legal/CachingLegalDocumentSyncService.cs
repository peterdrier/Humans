...
[Grandfathered(
    ruleId: "HUM0020",
    justification: "Pre-existing cache decorator warms legal document snapshots directly from ILegalDocumentRepository. Migrate warm/load paths to keyed inner service before removing.",
    since: "2026-05-24",
