...
// SectionControllerFeatureProvider keys off, so the internal GateController /
// GateVendorBackfillAdminController are still discovered and routed
// (memory/architecture/section-controllers-need-feature-provider.md).
[assembly: Section("Gate")]
