...
// SectionControllerFeatureProvider keys off, so the two internal Teams controllers are still
// discovered and routed
// (memory/architecture/section-controllers-need-feature-provider.md).
[assembly: Section("Teams")]

// Castle DynamicProxy, behind NSubstitute in Humans.Teams.Tests, needs to see the internal
