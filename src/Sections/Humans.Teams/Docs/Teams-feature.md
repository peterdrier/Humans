...
> **Section invariants** (data model, entity fields, system-team sync rules, routing, authorization, owning services): [`src/Sections/Humans.Teams/Docs/Teams.md`](Teams.md). This file is the user-facing spec — stories, acceptance criteria, and workflows.
...
- [Authentication](../../Humans.Auth/Docs/authentication.md) — Board role enables team creation
- [Volunteer Status](../../Humans.Onboarding/Docs/volunteer-status.md) — Determines Volunteers team membership
- [Google Integration](../../Humans.GoogleIntegration/Docs/google-integration.md) — Team resource provisioning
