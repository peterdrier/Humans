...
internal sealed class TeamRoleAssignmentConfiguration : IEntityTypeConfiguration<TeamRoleAssignment>
{
    public void Configure(EntityTypeBuilder<TeamRoleAssignment> builder)
    {
        ...
        // AssignedByUserId is a bare cross-section Guid column — no FK constraint, no nav.
    }
}
