...
internal sealed record WorkloadReport(
...
/// </summary>
internal sealed record WorkloadByPersonRow(
    Guid UserId,
    string DisplayName,
...
/// </summary>
internal sealed record WorkloadByRotaRow(
    Guid RotaId,
    string RotaName,
    Guid TeamId,
    string TeamName,
...
/// </summary>
internal sealed record WorkloadByDepartmentRow(
    Guid TeamId,
    string TeamName,
    string TeamSlug,
    int RotaCount,
