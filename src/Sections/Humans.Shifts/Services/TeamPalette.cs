...
internal static class TeamPalette
{
    ...
    internal static string ColorFor(Guid teamId)
    {
        // Guid.ToString("D") is load-bearing — see the section's Docs/Shifts.md (Invariants).
