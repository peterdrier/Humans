...
- **[35 — Dietary & Medical Nudge](../../Humans.Users/Docs/dietary-medical-nudge.md)**: Collect dietary/allergy/medical info when a human signs up for a 6+ hour shift where the cantina provides meals (shipped — a full page, not a modal)
...
The following fields are no longer editable on `/Profile/Me/ShiftInfo`. They moved to `Profile` (Feature 35 — [Dietary & Medical Nudge](../../Humans.Users/Docs/dietary-medical-nudge.md)); the corresponding `VolunteerEventProfile` columns are retained-only tombstones pending a deferred drop:
- `DietaryPreference`
...
- [25 — Shift Management](shift-management.md): parent shift system
...
- [Feature 35 — Dietary & Medical Nudge](../../Humans.Users/Docs/dietary-medical-nudge.md) (shipped)
