...
- [Teams](../../../Humans.Teams/Docs/features/Teams-feature.md) — `IsPromotedToDirectory` is set in Team admin.
- Section invariants: [`src/Sections/Humans.Shifts/Docs/Shifts.md`](../Shifts.md#department-coverage-pies).
