...
- [Onboarding Pipeline](../../../Humans.Onboarding/Docs/features/onboarding-pipeline.md) — Where coordinator roles fit in the pipeline
- [Board Voting](../../../Humans.Governance/Docs/features/board-voting.md) — Board-only voting on tier applications (separate from consent check)
- [Administration](../../../../../docs/features/global/administration.md) — Admin area and role management
- [Volunteer Status](../../../Humans.Onboarding/Docs/features/volunteer-status.md) — MembershipRequiredFilter and access gating
