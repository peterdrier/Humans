...
/// <summary>
/// Marker type for Search's resource set — the <c>Search_Filter*</c> and <c>Search_Global*</c>
/// keys. The <c>.resx</c> files sit beside this file and the manifest name derives from this
