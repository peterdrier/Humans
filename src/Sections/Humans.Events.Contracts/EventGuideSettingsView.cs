...
/// read from the Settings-owned event settings table at warm /
/// refresh time via <c>ISettingsService</c>. The Events section has no
...
/// once <c>ISettingsService</c> exposes an invalidation signal, this
