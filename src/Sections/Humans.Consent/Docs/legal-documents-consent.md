...
- [Volunteer Status](../../Humans.Onboarding/Docs/volunteer-status.md) - Status depends on consent completion
- [Background Jobs](../../../../docs/features/global/background-jobs.md) - Document sync and reminder jobs
- [Profiles](../../Humans.Users/Docs/profiles.md) - Consent status shown on profile
