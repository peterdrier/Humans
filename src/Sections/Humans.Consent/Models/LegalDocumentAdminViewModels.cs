...
internal sealed class LegalDocumentListViewModel
{
...
internal sealed class LegalDocumentListItemViewModel
{
...
internal sealed class LegalDocumentEditViewModel
{
    public Guid? Id { get; set; }
...
internal sealed class DocumentVersionSummaryViewModel
{
    public Guid Id { get; set; }
...
internal sealed class TeamSelectItem
{
    public Guid Id { get; set; }
    public string Name { get; set; } = string.Empty;
}
