...
/// </summary>
/// <remarks>
/// On the leaf because Shell's <c>GuestController</c> bounces a mid-widget user back
/// into the flow with it; the section's own dispatcher and progress banner are the
/// other two consumers.
/// </remarks>
