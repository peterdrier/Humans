...
/// <c>VolunteerHistoryEntry.Id</c>. Existing rows round-trip through the
/// editor with their original Id; new rows post <see cref="Guid.Empty"/> and
/// are assigned a fresh Id on insert.
/// </remarks>
