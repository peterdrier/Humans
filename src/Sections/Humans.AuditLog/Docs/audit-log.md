...
The full value catalog lives in [`src/Sections/Humans.AuditLog/Docs/AuditLog.md`](AuditLog.md) and is regenerated from `src/Sections/Humans.AuditLog.Contracts/AuditAction.cs` by `/freshness-sweep`. It is not duplicated here — one source of truth.
...
- [F-05: Volunteer Status](../../Humans.Onboarding/Docs/volunteer-status.md) — Suspension triggers audit entries
...
- [F-06: Teams](../../Humans.Teams/Docs/Teams-feature.md) — Team sync produces audit entries
- [F-13: Drive Activity Monitoring](../../Humans.GoogleIntegration/Docs/drive-activity-monitoring.md) — Anomalous permission detection
