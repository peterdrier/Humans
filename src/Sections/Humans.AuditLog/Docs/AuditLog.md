...
- **Workgroups:** `WorkgroupRegistered`, `WorkgroupReferred`, `WorkgroupRefused`, `WorkgroupWithdrawn`, `WorkgroupClosed`, `WorkgroupReactivated`, `WorkgroupCoordinatorsChanged`, `WorkgroupDispositionRecorded`, `WorkgroupRegisteredExisting`, `WorkgroupDormancyFlagged`, `WorkgroupCloseCandidateFlagged`, `WorkgroupApplicationOverdue`, `WorkgroupUpdateDueNotified`, `WorkgroupLogEntryDeleted`, `WorkgroupCommentHidden`, `WorkgroupsRootFolderUpdated`, `WorkgroupDormancyCleared` — written by `WorkgroupService`; clearing an answered dormancy inquiry records its original flag time and qualifying activity time, after the flag change is saved, under the member or daily-job actor.
