...
/// </summary>
/// <remarks>
/// There is no <c>ISurveyServiceRead</c>: it shipped empty in v1 and no other section ever
/// consumed Surveys, so the assembly boundary is now the whole story. The one consumer outside
