...
- [Onboarding Pipeline](../../Humans.Onboarding/Docs/onboarding-pipeline.md) — How tier selection fits into the signup flow
...
- [Coordinator Roles](../../Humans.Shifts/Docs/coordinator-roles.md) — Consent check gate (Volunteer only)
- [Teams](../../Humans.Teams/Docs/Teams-feature.md) — Volunteers, Colaboradors, Asociados system teams
