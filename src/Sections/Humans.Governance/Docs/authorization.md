...
| `GovernanceApplicationsController.AdminTermExpiry` | Action | `Admin` | `PolicyNames.AdminOnly` |
| `GovernanceApplicationsController.AdminTermExpiryFix` | Action | `Admin` | `PolicyNames.AdminOnly` |
