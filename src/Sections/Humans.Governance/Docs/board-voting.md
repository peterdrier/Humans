...
Board voting only applies to tier applications (Colaborador and Asociado). Volunteer access is handled automatically through the consent check gate — see [Onboarding Pipeline](../../Humans.Onboarding/Docs/onboarding-pipeline.md).
...
### Application Changes (from [Membership Tiers](membership-tiers.md))
```
...
- [Onboarding Pipeline](../../Humans.Onboarding/Docs/onboarding-pipeline.md) — Where Board voting fits in the pipeline
- [Coordinator Roles](../../Humans.Shifts/Docs/coordinator-roles.md) — Consent check gate (separate from Board voting)
