...
- [Teams & Working Groups](../../Humans.Teams/Docs/Teams-feature.md) — Calendar events are owned by teams; the team reference is recorded on every audit entry for team-scoped audit filtering
