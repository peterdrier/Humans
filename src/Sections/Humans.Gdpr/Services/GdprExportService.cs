...
/// Sequential, not Task.WhenAll — a simplicity choice, not a correctness one. The shared scoped
/// DbContext that once made overlapping contributors unsafe is gone; each reads through its own
/// <c>IDbContextFactory&lt;T&gt;</c>, and design-rules.md §8a records the old reason as obsolete.
/// One contributor at a time keeps failure attribution and log order plain, and overlapping them
