...
/// Humans.Users — because the only data surface it names is Gdpr's own
/// <see cref="IGdprService"/>; everything else it takes (the caller-identity read,
/// a clock, a logger) every controller takes.
/// </summary>
[Authorize]
