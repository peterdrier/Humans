...
- [`email-outbox.md`](../../Humans.Email/Docs/email-outbox.md) — outbox infrastructure, `MessageCategory`, branded-template composition
- [`profiles.md`](../../Humans.Users/Docs/profiles.md) — `UserEmail` rows, `IsGoogle` flag, email rotation flows
