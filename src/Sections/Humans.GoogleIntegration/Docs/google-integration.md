...
- [Teams](../../Humans.Teams/Docs/Teams-feature.md) - Triggers Google Group provisioning and access sync
- [Background Jobs](../../../../docs/features/global/background-jobs.md) - Resource sync job
- [Authentication](../../Humans.Auth/Docs/authentication.md) - User Google identity
