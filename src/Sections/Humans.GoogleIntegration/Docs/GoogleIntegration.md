...
| `/Google/SyncSettings` | GET | Admin | Redirects to `/Settings#google-sync` (peterdrier/Humans#1634) |
| `/Google/SyncSettings` | POST | Admin | Update sync mode for a service (posted from the `/Settings#google-sync` tab) |
