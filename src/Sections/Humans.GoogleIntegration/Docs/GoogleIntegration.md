...
- Without Google credentials, the outbox job reports `skipped` and the processor leaves every event pending without dispatching stubs or changing `GoogleEmailStatus`.
