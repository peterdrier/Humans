...
- [Email Management](../../Humans.Users/Docs/preferred-email.md) — UserEmail entity, notification target, Google service email (US-11.7 cross-references this feature)
- [Google Integration](google-integration.md) — Shared Drives and Groups (separate from user account provisioning)
- [Email Outbox](../../Humans.Email/Docs/email-outbox.md) — Delivery mechanism for the credentials email
- [Audit Log](../../Humans.AuditLog/Docs/audit-log.md) — WorkspaceAccountProvisioned action
