...
> **See [Workspace Account Provisioning](../../Humans.GoogleIntegration/Docs/workspace-account-provisioning.md) for full details** including the provisioning flow, credentials email, ordering constraints, and 2FA requirements.
...
- [Authentication](../../Humans.Auth/Docs/authentication.md) - OAuth provides primary email
