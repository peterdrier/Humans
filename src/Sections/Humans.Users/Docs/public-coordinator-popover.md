...
- [`src/Sections/Humans.Users/Docs/profile-pictures-birthdays.md`](profile-pictures-birthdays.md) — `[AllowAnonymous] /Profile/{id}/Picture` pattern this endpoint mirrors.
