...
- [Authentication](../../Humans.Auth/Docs/authentication.md) - Profile created after first login
- [Volunteer Status](../../Humans.Onboarding/Docs/volunteer-status.md) - Computed from profile approval + consents
