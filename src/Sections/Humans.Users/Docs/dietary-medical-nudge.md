...
- [33 — Shift Preference Wizard](../../Humans.Shifts/Docs/shift-preference-wizard.md): removed dietary/medical from `/Profile/ShiftInfo`, creating the need for this nudge.
- [25 — Shift Management](../../Humans.Shifts/Docs/shift-management.md): supplies the `ShiftSignup` rows the gate queries.
