...
- [Authentication](../../../Humans.Auth/Docs/features/authentication.md) - Profile created after first login
- [Volunteer Status](../../../Humans.Onboarding/Docs/features/volunteer-status.md) - Computed from profile approval + consents
- [Contact Fields](contact-fields.md) - Granular contact info visibility
- [Administration](../../../../../docs/features/global/administration.md) - Admin member management
- [Profile Pictures & Birthdays](profile-pictures-birthdays.md) - Custom profile pictures and birthday calendar
