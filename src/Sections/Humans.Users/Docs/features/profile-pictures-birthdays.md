...
- [Profiles](profiles.md) - Profile entity and edit flow
- [Teams](../../../Humans.Teams/Docs/features/Teams-feature.md) - Team detail page and membership
- [Contact Fields](contact-fields.md) - Other profile visibility controls
