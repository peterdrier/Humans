...
namespace Humans.Users.Data.Migrations
{
    ...
    [Migration("20260821025206_AddUserNameColumns")]
    partial class AddUserNameColumns
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Humans.Users.Contracts.EventParticipation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Humans.Users.Contracts.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Humans.Users.Contracts.UserEmail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Humans.Users.Domain.AccountMergeRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Humans.Users.Domain.CommunicationPreference", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Humans.Users.Domain.ContactField", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Humans.Users.Domain.Profile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Humans.Users.Domain.ProfileLanguage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Humans.Users.Domain.VolunteerHistoryEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Humans.Users.Contracts.EventParticipation", b =>
                {
                    b.HasOne("Humans.Users.Contracts.User", null)
            ...
            modelBuilder.Entity("Humans.Users.Domain.AccountMergeRequest", b =>
                {
                    b.HasOne("Humans.Users.Contracts.User", "ResolvedByUser")
                        .WithMany()
                        .HasForeignKey("ResolvedByUserId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Humans.Users.Contracts.User", "SourceUser")
                        .WithMany()
                        .HasForeignKey("SourceUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Humans.Users.Contracts.User", "TargetUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Humans.Users.Domain.ContactField", b =>
                {
                    b.HasOne("Humans.Users.Domain.Profile", "Profile")
            ...
            modelBuilder.Entity("Humans.Users.Domain.Profile", b =>
                {
                    b.HasOne("Humans.Users.Contracts.User", null)
                        .WithOne()
                        .HasForeignKey("Humans.Users.Domain.Profile", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
