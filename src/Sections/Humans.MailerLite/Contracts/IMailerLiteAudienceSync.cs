...
/// <summary>
/// The audience push <c>MailerLiteAudienceSyncJob</c> drives. Everything the sync needs — the
...
/// </summary>
/// <remarks>
/// Deliberately narrower than the section's own <c>IMailerLiteAudienceSyncService</c>: the job
...
/// </remarks>
public interface IMailerLiteAudienceSync
{
    /// <summary>
