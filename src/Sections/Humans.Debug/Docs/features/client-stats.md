...
- [`src/Sections/Humans.Debug/Docs/features/http-errors.md`](http-errors.md) — the per-request detail buffer behind the status-code tally (status > 399, last 1000).
- [`Debug.md`](../Debug.md) — the Debug section that owns this screen.
- [`docs/features/global/active-user-metrics.md`](../../../../../docs/features/global/active-user-metrics.md) — the sibling in-memory metric (active users); same reset-on-restart constraint.
