...
/// <summary>
/// Debug's admin sidebar group: the diagnostics pages, then the design galleries.
/// </summary>
internal sealed class SectionAdminNav : ISectionAdminNav
{
    ...
    [
        new("Debug", [
            ...
            new("Color palette", "ColorPalette",  "Index",         null, null, "fa-solid fa-palette",  PolicyNames.AdminOnly, Weight: 110),
            new("Components",    "WidgetGallery", "Index",         null, null, "fa-solid fa-shapes",   PolicyNames.AdminOnly, Weight: 120),
            new("Date formats",  "Debug",         "FormatGallery", null, null, "fa-solid fa-clock",    PolicyNames.AdminOnly, Weight: 130),
            new("Translations",  "Debug",         "Translations",  null, null, "fa-solid fa-language", PolicyNames.AdminOnly, Weight: 140)
        ])
    ];
}
