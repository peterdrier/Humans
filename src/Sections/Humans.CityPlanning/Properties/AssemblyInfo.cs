...
// SectionControllerFeatureProvider keys off, so the internal CityPlanningController /
// CityPlanningApiController are still discovered and routed
// (memory/architecture/section-controllers-need-feature-provider.md).
[assembly: Section("CityPlanning")]
