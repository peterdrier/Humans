...
- [Camps](../../Humans.Camps/Docs/Camps-feature.md) — `CampSeason` is the anchor entity; placement requires an approved camp season for the current year
- [Authentication](../../Humans.Auth/Docs/authentication.md) — All map routes require authentication
