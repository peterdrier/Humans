...
(on-site cohort per day, via `GetOnSiteUserIdsForDayAsync`), `ISettingsService`
(active-event metadata — `GetActiveEventSettingsAsync` returning `EventSettingsInfo`, for
