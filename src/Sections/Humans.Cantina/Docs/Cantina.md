...
**Status:** (A) Migrated — new section in feature [#36](daily-roster.md); built directly on the §15 pattern from day one, moved into its own project unchanged.
