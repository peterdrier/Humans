...
/// <summary>
/// Maps <c>app_event_settings</c>. The name is not <c>event_settings</c> because
/// the Shifts-owned table of that name still exists — retiring it, and taking the
/// plain name, is the separate third step after this schema ships and the values
...
internal sealed class EventSettingsConfiguration : IEntityTypeConfiguration<EventSettings>
{
    ...
    {
        builder.ToTable("app_event_settings");
