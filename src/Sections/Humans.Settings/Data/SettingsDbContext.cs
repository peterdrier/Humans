...
/// <summary>
/// Per-section database context for the Settings section: maps <c>system_settings</c> (the app-wide
...
/// </summary>
/// <remarks>
/// Internal-sealed like every section context: repositories are the
