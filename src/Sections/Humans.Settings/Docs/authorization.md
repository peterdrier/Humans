...
| `SettingsAdminController` POST (`/Settings/Admin`) | Class | `Admin` | `PolicyNames.AdminOnly` — the app-wide event settings write, incl. minting a new cycle, #1104/#1631; no GET remains |
