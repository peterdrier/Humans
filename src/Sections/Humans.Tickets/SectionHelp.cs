...
/// <summary>
/// Section-help Guide and Glossary content for the Tickets pages — was a row in
...
internal sealed class SectionHelp : ISectionHelp
{
    ...
    [
        SectionHelpEntry.FromEmbeddedMarkdown(typeof(SectionHelp).Assembly, "Tickets", 90),
    ];
}
