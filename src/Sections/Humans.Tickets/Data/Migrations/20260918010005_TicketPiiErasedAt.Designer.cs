...
namespace Humans.Tickets.Data.Migrations
{
    ...
    [Migration("20260918010005_TicketPiiErasedAt")]
    partial class TicketPiiErasedAt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Humans.Tickets.Domain.TicketAttendee", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Instant?>("PiiErasedAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Humans.Tickets.Domain.TicketOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Humans.Tickets.Domain.TicketSyncState", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Humans.Tickets.Domain.TicketTransferRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Humans.Tickets.Domain.TicketAttendee", b =>
                {
                    b.HasOne("Humans.Tickets.Domain.TicketOrder", "TicketOrder")
                        .WithMany("Attendees")
            ...
            modelBuilder.Entity("Humans.Tickets.Domain.TicketTransferRequest", b =>
                {
                    b.HasOne("Humans.Tickets.Domain.TicketAttendee", "OriginalTicketAttendee")
                        .WithMany()
