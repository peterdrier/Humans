...
- [22. Campaigns](../../Humans.Campaigns/Docs/Campaigns-feature.md) — discount code distribution and redemption tracking
- [23. Membership Status](../../Humans.Governance/Docs/membership-status.md) — "Who Hasn't Bought?" uses active volunteer status
