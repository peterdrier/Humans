...
leaf carries what Base consumers need and stays framework-free, the folder carries public surface
that needs ASP.NET (`TicketStubViewComponent`). All section services route every database
