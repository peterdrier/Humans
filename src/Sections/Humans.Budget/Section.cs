...
/// </summary>
/// <remarks>
/// <c>TicketingBudgetSyncJob</c> is Budget's — both its collaborators are Budget's and the
/// rows it writes are budget line items. Its schedule is contributed via
