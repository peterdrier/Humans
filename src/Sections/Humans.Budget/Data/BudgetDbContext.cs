...
/// <summary>
/// Per-section database context for the Budget section: maps only
/// <c>budget_years</c>, <c>budget_groups</c>, <c>budget_categories</c>,
/// <c>budget_line_items</c>, <c>budget_audit_logs</c> and
/// <c>ticketing_projections</c>, with its own
...
/// Identity tables are deliberately absent here.
/// </remarks>
