...
// SectionControllerFeatureProvider keys off, so the internal BudgetController /
// BudgetAdminController are still discovered and routed
// (memory/architecture/section-controllers-need-feature-provider.md).
[assembly: Section("Budget")]
