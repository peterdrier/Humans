...
internal sealed record DevelopmentBudgetSeedResult(
    Guid BudgetYearId,
    ...
    ILogger<DevelopmentBudgetSeeder> logger) : IBudgetDemoSeeder
{
    ...
    public async Task<string> SeedAsync(Guid actorUserId, CancellationToken cancellationToken = default)
    {
        ...
        return new DevelopmentBudgetSeedResult(
            ...
            LineItemsCreated: lineItemsCreated).SuccessMessage;
    }
