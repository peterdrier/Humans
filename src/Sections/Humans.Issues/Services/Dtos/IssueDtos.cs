...
internal abstract record IssueThreadEvent(Instant At, Guid? ActorUserId, string? ActorDisplayName);
...
internal sealed record IssueAuditEvent(
    Instant At,
    Guid? ActorUserId,
    string? ActorDisplayName,
    AuditAction Action,
...
internal sealed record IssueListFilter(
