...
// SectionControllerFeatureProvider keys off, so the internal IssuesController and
// IssuesApiController are still discovered and routed
// (memory/architecture/section-controllers-need-feature-provider.md).
[assembly: Section("Issues")]
