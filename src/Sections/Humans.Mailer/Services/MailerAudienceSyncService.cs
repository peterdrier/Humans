...
/// </summary>
internal sealed class MailerAudienceSyncService(
    IMailerLiteService ml,
    IUserEmailService emails,
    IAuditLogService audit,
    IEnumerable<IMailerAudience> audiences,
    ILogger<MailerAudienceSyncService> logger) : IMailerAudienceSyncService, IMailerAudienceSync
{
    ...
    /// <summary>
    /// The <see cref="IMailerAudienceSync"/> half, driven by <c>MailerAudienceSyncJob</c>.
