...
/// <summary>
/// Per-section database context for the Backdoor section
/// (nobodies-collective/Humans#858): maps only <c>backdoor_api_keys</c>, with its own
...
/// </summary>
/// <remarks>
/// Internal-sealed like every section context (issue #750): the repository is the only
