...
/// <summary>
/// The authentication scheme a Backdoor API key produces. Public so the Shell's onboarding
/// gates can tell a machine request apart from a browsing session — see
