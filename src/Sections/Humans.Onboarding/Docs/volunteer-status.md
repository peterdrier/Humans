...
- [Membership Tiers](../../Humans.Governance/Docs/membership-tiers.md) — Tier definitions (Volunteer is baseline)
- [Onboarding Pipeline](onboarding-pipeline.md) — Full onboarding flow
- [Coordinator Roles](../../Humans.Shifts/Docs/coordinator-roles.md) — Consent Coordinator performs safety checks
- [Authentication](../../Humans.Auth/Docs/authentication.md) — UserState access claim, role claims
- [Legal Documents & Consent](../../Humans.Consent/Docs/legal-documents-consent.md) — Consent completion contributes to Volunteers eligibility (name + consents)
- [Teams](../../Humans.Teams/Docs/Teams-feature.md) — Volunteers team is a Google Workspace provisioning group (name + consents), not the access gate
