...
// internal OnboardingReviewController, OnboardingWidgetController and
// OnboardingProgressBannerViewComponent are still discovered and routed
// (memory/architecture/section-controllers-need-feature-provider.md).
[assembly: Section("Onboarding")]
