...
internal sealed class CampRoleDrillDownViewModel
{
...
internal sealed record CampRoleDrillDownCampRowViewModel(
    Guid CampId,
    string CampName,
    string CampSlug,
    Guid CampSeasonId,
...
internal sealed record CampRoleDrillDownAssigneeViewModel(
    Guid UserId);
