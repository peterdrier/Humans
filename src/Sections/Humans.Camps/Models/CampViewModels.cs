...
// Public listing
internal sealed class CampIndexViewModel
{
...
internal sealed class CampCardViewModel
{
...
internal sealed class CampLeadPositionPillViewModel
{
    public string Name { get; set; } = string.Empty;
...
internal sealed class CampFilterViewModel
{
...
// Detail page
internal sealed class CampDetailViewModel
{
    public Guid Id { get; set; }
    public string Slug { get; set; } = string.Empty;
    public string Name { get; set; } = string.Empty;
    ...
    public CampRolesPanelViewModel? RolesPanel { get; set; }
...
/// </summary>
internal sealed class CampMembershipStateViewModel
{
...
internal enum CampMemberStatusSummaryView
{
    NoOpenSeason,
    None,
    Pending,
...
internal sealed class CampSeasonDetailViewModel
{
    public Guid Id { get; set; }
    public int Year { get; set; }
    public string Name { get; set; } = string.Empty;
...
internal sealed class CampLeadViewModel
{
...
// Edit form
internal sealed class CampEditViewModel : CampRegisterViewModel
{
...
internal sealed class CampMemberRowViewModel
{
    public Guid CampMemberId { get; set; }
    public Guid UserId { get; set; }
...
internal sealed class CampImageViewModel
{
    public Guid Id { get; set; }
...
internal sealed class CampHistoricalNameViewModel
{
    public Guid Id { get; set; }
    public string Name { get; set; } = string.Empty;
    public int? Year { get; set; }
...
// Contact form
internal sealed class CampContactViewModel
{
...
// Admin dashboard
internal sealed class CampAdminViewModel
{
