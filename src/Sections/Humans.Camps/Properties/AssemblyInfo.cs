...
// SectionControllerFeatureProvider keys off, so the four internal Camps controllers are still
// discovered and routed
// (memory/architecture/section-controllers-need-feature-provider.md).
[assembly: Section("Camps")]

// Castle DynamicProxy, behind NSubstitute in Humans.Camps.Tests, needs to see the internal
