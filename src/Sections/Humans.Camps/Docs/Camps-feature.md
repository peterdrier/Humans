...
- [Authentication](../../Humans.Auth/Docs/authentication.md) - User identity for camp registration and lead management
- [Teams](../../Humans.Teams/Docs/Teams-feature.md) - Similar self-organizing group concept; camps are event-specific
