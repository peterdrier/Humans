    ...
    ILogger<EmailRenderer> logger) : IEmailRenderer
{
    ...
    public EmailContent RenderWorkgroupNotice(WorkgroupNoticeRequest request)
        => RenderLocalized(request.Culture, () =>
        {
            ...
            var name = HtmlEncode(request.WorkgroupName);
