...
- [`src/Sections/Humans.Users/Docs/preferred-email.md`](../../Humans.Users/Docs/preferred-email.md) — base email management feature; the Set Primary / Set Google flow this remediation extends.
