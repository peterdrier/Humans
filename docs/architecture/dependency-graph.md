...
graph LR
    ...
    %% Eager count: 289 eager links, indices 0..288. (Unchanged vs prior sweep — 2026-08-13
    %% sweep verified the Teams/Tickets G5 batch #3 move (PR #1280) against every moved
    %% service's current ctor and found no edge changes; see the "G5 batch #3" note below.)
    %% The 20 lazy edges are indices 289..308. (unchanged count vs prior sweep.)
