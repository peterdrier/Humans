...
| 2026-08-18 | Finance | First scheduled run (plan written this run): deep assessment + strike | Section doc rewritten off the pre-G5 controller (23 phantom routes, phantom Tickets dependency, shipped read-split still listed as future work) + claim swept into 4 more files; 2 untested invariants pinned (Madrid date conversion, contact-list cache); 2 InspectCode findings | peterdrier/Humans#PENDING |
