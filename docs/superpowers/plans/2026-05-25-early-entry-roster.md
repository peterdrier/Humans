...
- Spec: `docs/superpowers/specs/2026-05-25-early-entry-roster-design.md` (historical — since deleted; the shipped roster route lives in [`docs/sections/Shifts.md`](../../sections/Shifts.md) and the EE-stub rule in [`src/Sections/Humans.Tickets/Docs/Tickets.md`](../../../src/Sections/Humans.Tickets/Docs/Tickets.md)).
