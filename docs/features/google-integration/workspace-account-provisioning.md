...
- [Email Management](../profiles/preferred-email.md) — UserEmail entity, notification target, Google service email (US-11.7 cross-references this feature)
- [Google Integration](../google-integration/google-integration.md) — Shared Drives and Groups (separate from user account provisioning)
- [Email Outbox](../email/email-outbox.md) — Delivery mechanism for the credentials email
- [Audit Log](../audit-log/audit-log.md) — WorkspaceAccountProvisioned action
