...
- [33 — Shift Preference Wizard](../shifts/shift-preference-wizard.md): removes dietary/medical from the preference page
- [25 — Shift Management](../shifts/shift-management.md): shift signup data
