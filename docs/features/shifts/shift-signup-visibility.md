...
- [25 — Shift Management](../shifts/shift-management.md): parent feature
- [09 — Administration](../global/administration.md): admin role checks
- [17 — Coordinator Roles](../shifts/coordinator-roles.md): coordinator authorization
