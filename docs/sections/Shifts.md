...
**Owning services:** `ShiftManagementService`, `ShiftSignupService`, `GeneralAvailabilityService`, `VolunteerTrackingService`, `EventSettingsService` (read-only supplier API for cross-section `EventSettings` reads — issue nobodies-collective/Humans#719)
