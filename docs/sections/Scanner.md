...
- **Architecture test:** none. The general `NoControllerInjectsDbContext` and `NoServiceInjectsDbContext` ratchet tests in `tests/Humans.Application.Tests/Architecture/` cover this controller; no section-specific test is warranted at this size.
