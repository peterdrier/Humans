...
- `CampRepository` lives in `Humans.Infrastructure.Repositories.Camps`, uses `IDbContextFactory<CampsDbContext>` (nobodies-collective/Humans#858), and is registered as Singleton.
