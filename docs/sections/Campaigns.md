...
- **Architecture test** — no dedicated `CampaignArchitectureTests.cs` exists. Cross-cutting architecture coverage (`NoCrossSectionEfJoins`, `HUM0021`, `HUM0009`) covers this section generically.
