...
- **Architecture test** — no dedicated `CampaignArchitectureTests.cs` exists. Cross-cutting architecture coverage (`HUM0024`, `NoObsoleteNavReads`, `HUM0009`) covers this section generically.
