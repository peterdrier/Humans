...
**Metrics**: `humans.google_sync_outbox_pending`, `humans.sync_operations_total`. Registered by `GoogleIntegrationMetricsRegistrar` (gauges) and `ProcessGoogleSyncOutboxJob` (counters).
