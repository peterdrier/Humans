...
8. **Link to specs, do not duplicate.** Workflows belong in `docs/features/<section>/<feature>.md`; UI text choices belong in CLAUDE.md. Section docs point to those files, they do not copy from them.
