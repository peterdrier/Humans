...
**G1: 3 gaps (5 entity-leak baseline rows needing caller audit, 5 Obsolete-nav debt items already tracked, HUM0031×2 tracked) · G3: 2 gaps (EF-InMemory repo test, DbContext-backed service tests) — largest G1.5 debt surface by row-count of the 9 sections, but all items are named/documented rather than silent**
