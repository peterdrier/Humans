...
**G1: 4 gaps (corrected 2026-08-03, was 3 — 10 entity-leak baseline rows with 2 in-flight via #809, HUM0031×1 tracked, added: two writer-services on `shift_signups`) · G3: 2 gaps (EF-InMemory repo tests ×3, DbContext-backed service tests ×12 — largest G3.2 gap in the batch)**
