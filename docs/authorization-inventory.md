...
| `src/Humans.Web/Controllers/ExpensesController.cs` | 185, 552, 598, 618, 663, 684, 711, 771 | `AuthorizeAsync(User, report, new ExpenseReportOperationRequirement(ExpenseReportOperation.X))` — `View` (Detail 185, Attachment 552), `Endorse` 598, `CoordinatorReject` 618, `Approve` 663, `FinanceReject` 684, `ReopenSepa` 711, `IncludeInSepaPayout` 771 |
