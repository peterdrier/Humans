...
| [Mailer Audience Debug Screen](../src/Sections/Humans.MailerLite/Docs/features/audience-debug-screen.md) | Per-audience debug screen previewing exactly what the next MailerLite `Sync` would apply, so admins can spot anomalies before pulling the trigger |
...
| [Mailer](../src/Sections/Humans.MailerLite/Docs/Mailer.md) | Humans ↔ MailerLite synchronisation: inbound import and outbound audience management |
