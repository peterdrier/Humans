...
1. Builds a preload corpus from the repo: all `docs/sections/*.md`, every feature spec (`src/Sections/*/Docs/*.md` + `docs/features/global/*.md`), and the raw `AccessMatrixDefinitions.cs` / `SectionHelpContent.cs` files.
