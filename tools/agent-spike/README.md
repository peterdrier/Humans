...
1. Builds a preload corpus from the repo: all `docs/sections/*.md`, every feature spec (`src/Sections/*/Docs/features/*.md` + `docs/features/global/*.md`), and the raw `SectionAccessMatrix.cs` / `SectionHelpContent.cs` files.
