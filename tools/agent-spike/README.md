...
1. Builds a preload corpus from the repo: all `docs/sections/*.md`, every feature spec (`src/Sections/*/Docs/features/*.md` + `docs/features/global/*.md`), and each section's `SectionAccessMatrix.cs` / `SectionHelp.cs` files.
